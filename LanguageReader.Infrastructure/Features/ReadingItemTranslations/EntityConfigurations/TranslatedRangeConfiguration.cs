...
namespace LanguageReader.Infrastructure.Features.ReadingItemTranslations.EntityConfigurations;
...
internal sealed class TranslatedRangeConfiguration : IEntityTypeConfiguration<TranslatedRangeEntity>
{
    public void Configure(EntityTypeBuilder<TranslatedRangeEntity> entity)
    {
        ...
        entity.Property(range => range.Kind).HasColumnName("kind").HasConversion<string>().HasMaxLength(32).IsRequired();
