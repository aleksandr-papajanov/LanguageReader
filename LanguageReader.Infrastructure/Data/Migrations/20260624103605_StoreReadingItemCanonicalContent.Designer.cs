...
namespace LanguageReader.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260624103605_StoreReadingItemCanonicalContent")]
    partial class StoreReadingItemCanonicalContent
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LanguageReader.Infrastructure.Features.ReadingItems.Entities.ReadingItemPageEntity", b =>
                {
                    b.Property<Guid>("ReadingItemId")
                        .HasColumnType("uuid")
                        .HasColumnName("reading_item_id");
                    ...
                    b.Property<int>("EndSequenceIndex")
                        .HasColumnType("integer")
                        .HasColumnName("end_sequence_index");

                    b.Property<int>("StartBlockIndex")
                        .HasColumnType("integer")
                        .HasColumnName("start_block_index");

                    b.Property<int>("StartSequenceIndex")
                        .HasColumnType("integer")
                        .HasColumnName("start_sequence_index");

                    b.Property<int>("Weight")
                        .HasColumnType("integer")
                        .HasColumnName("weight");

                    b.HasKey("ReadingItemId", "PageIndex");

                    b.HasIndex("ReadingItemId", "StartBlockIndex", "EndBlockIndex");

                    b.ToTable("reading_item_pages", (string)null);
                });
            ...
            modelBuilder.Entity("LanguageReader.Infrastructure.Features.Vocabulary.Entities.VocabularyEntryEntity", b =>
                {
                    ...
                    b.ToTable("vocabulary_entries", null, t =>
                        {
                            t.HasCheckConstraint("ck_vocabulary_entries_kind", "kind IN ('LexicalUnit', 'Text')");
                        });
                });
